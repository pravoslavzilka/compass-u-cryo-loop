...
model TFTest
  ...
  ThermalSystems.GasComponents.Fans.Fan2ndOrder fan2ndOrder(
    ...
    V_flow_Start=0.01)
    "T_nominal/p_nominal match TFCircuit.mo's fan2ndOrder -- see tf-circulator-sizing.md."
...
equation
  ...
  connect(junction2.portB, fan2ndOrder.portA) annotation (Line(
      ...
      color={255,153,0},
      thickness=0.5));
  connect(tfCoilBus.portA1, fan2ndOrder.portB) annotation (Line(
      points={{25.2,44},{-28,44},{-28,28}},
      color={255,153,0},
      thickness=0.5));
  connect(tfCoilBus.portB1, tube1.portA) annotation (Line(
